...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("tupenca_mobile.Services.HttpsClientHandlerService+CustomAndroidMessageHandler+CustomHostnameVerifier, tupenca-mobile", HttpsClientHandlerService_CustomAndroidMessageHandler_CustomHostnameVerifier.class, __md_methods);
	}
	...
	public HttpsClientHandlerService_CustomAndroidMessageHandler_CustomHostnameVerifier ()
	{
		...
		if (getClass () == HttpsClientHandlerService_CustomAndroidMessageHandler_CustomHostnameVerifier.class)
			mono.android.TypeManager.Activate ("tupenca_mobile.Services.HttpsClientHandlerService+CustomAndroidMessageHandler+CustomHostnameVerifier, tupenca-mobile", "", this, new java.lang.Object[] {  });
	}
